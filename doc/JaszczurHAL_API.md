...
| 3 | [Build dependencies, tests, and hardware fixtures](api/03_build_tests.md) | Test architecture and sources of truth, dependencies, host/CI execution, full suite inventory, extension rules, mock time control, and centralized hardware-fixture procedures and results |
...
| `hal_power` | [Timers and system](api/06_timers_system.md) |
