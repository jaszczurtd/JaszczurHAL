...
| [`tests/hardware/rp_gpio_irq_context`](../../../tests/hardware/rp_gpio_irq_context/README.pl.md) | Przerwania GPIO z kontekstem: trafianie we własny pin, oba rodzaje handlerów obok siebie, podmiana i odłączenie |
...
| [`tests/hardware/esp32s3_phase2`](../../../tests/hardware/esp32s3_phase2/README.pl.md) | Sonda runtime Fazy 2 ESP32-S3 dla obu zadań aplikacji, system/sync, GPIO/IRQ wraz z handlerami z kontekstem, ADC, USB Serial/JTAG TX/RX, sprzętowy UART, skanowanie mastera I2C, ścieżka transferu mastera SPI, callbacki timera z dedykowanej puli oraz włączona konfiguracja stack-guard FreeRTOS. |
| [`tests/hardware/esp32s3_adc_scan`](../../../tests/hardware/esp32s3_adc_scan/README.pl.md) | Ciągły skan ADC na ESP32-S3: bloki po kolei, najnowsza próbka podążająca za pinem bez pobierania bloków, zapisy flash w czasie skanu, stop i ponowny start. |
