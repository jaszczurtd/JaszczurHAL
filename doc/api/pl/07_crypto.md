# Kryptografia - `hal_crypto`

*Dostępne również [po angielsku](../en/07_crypto.md).*
...
**Przykład: kodowanie i dekodowanie Base64**
```c
#include <hal/security/hal_crypto.h>
#include <string.h>
...
**Przykład: skrót SHA-256 (preferowany dla bezpieczeństwa)**
```c
#include <hal/security/hal_crypto.h>
#include <string.h>
...
**Przykład: HMAC-SHA256 (uwierzytelnianie wiadomości)**
```c
#include <hal/security/hal_crypto.h>
#include <string.h>
...
**Przykład: szyfrowanie strumieniowe ChaCha20**
```c
#include <hal/security/hal_crypto.h>
#include <string.h>
...
**Przykład: uwierzytelnione szyfrowanie ChaCha20-Poly1305 (AEAD)**
```c
#include <hal/security/hal_crypto.h>
#include <string.h>
...
*Dalej: [Synchronizacja i port szeregowy](08_sync_serial.md)*
