...
| ST77xx driver (ported) | ST7735/ST7789/ST7796S backends ported into `impl/shared/drivers/display/st77xx_driver.*` | Limor Fried (Ladyada) (Adafruit ST7735/ST7789) | BSD-2-Clause (attribution in source headers) | `src/hal/impl/shared/drivers/display/st77xx_driver.h` |
...
| Shared display stack | The vendored Adafruit GFX/ILI9341/ST77xx/SSD1306/BusIO libraries were replaced by a portable in-tree display stack (`impl/shared/drivers/display/`) built only on HAL SPI/I2C/GPIO. The OLED path now covers the SSD1306-family variants used by the public family init API. | One Arduino-free implementation drives every backend (RP2040, STM32G474) identically and compiles out when the display module is disabled. |
