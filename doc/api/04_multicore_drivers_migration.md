...
| Shared display stack | The vendored Adafruit GFX/ILI9341/ST77xx/SSD1306/BusIO libraries were replaced by a portable in-tree display stack (`impl/shared/drivers/display/`) built only on HAL SPI/I2C/GPIO. | One Arduino-free implementation drives every backend (RP2040, STM32G474) identically and compiles out when the display module is disabled. |
