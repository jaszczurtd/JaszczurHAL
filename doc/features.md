...
| ESP32-S3 backend | Production ESP-IDF project build/flash/artifact runner, safe USB Serial/JTAG selection, VS Code build/upload/monitor/IntelliSense/raw-app OTA, generated board/memory configuration, FreeRTOS task0/task1 dispatch, core/peripheral backends, and native WiFi/lwIP services. | [ESP32 implementation](../src/hal/impl/esp32/), [Phase 2 fixture](../tests/hardware/esp32s3_phase2/), [Phase 3 compile fixture](../tests/fixtures/esp32s3_phase3/) |
...
| JH BLE Stream v1 | Bounded byte stream over one static GATT service, versioned framing with capability negotiation, mutual HMAC-SHA256 proofs, directional ChaCha20-Poly1305 keys, replay and rate-limit protection, and bounded RX/TX queues. | [Bluetooth API](api/20_bluetooth.md) |
