...
| Stack protection | Opt-in target-neutral API backed by synchronous Pico SDK hardware guards on RP2040/RP2350 and a 32-byte MPU guard on STM32G474; FreeRTOS builds also check task stacks. | [hal_system.h](../src/hal/system/hal_system.h) |
