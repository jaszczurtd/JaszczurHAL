...
| Raw LoRa radio | Provider-neutral SX1262 lifecycle with DIO1-driven asynchronous TX/RX, blocking TX compatibility, callbacks, cancellation, explicit states, packet metadata, diagnostics, power states and time-on-air. | [LoRa radio API](api/21_lora.md), [hal_lora_radio.h](../src/hal/hal_lora_radio.h) |
