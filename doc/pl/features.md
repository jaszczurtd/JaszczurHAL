...
| Obsługa kompilatorów | Wspólny nagłówek ujednolica rozszerzenia GNU, Clang i MSVC: `noreturn`, wymuszone `inline`, `trap`/`unreachable`, pakowanie struktur i zliczanie wiodących zer. | [hal_compiler.h](../../src/hal/core/hal_compiler.h) |
...
| Biblioteki statyczne | Konfiguracje CMake i skrypty do kompilowania bibliotek dla RP z oficjalnym Pico SDK oraz dla STM32G474. Kompilacja RP dodatkowo sprawdza tworzenie plików ELF/BIN/UF2 i symbole punktów wejścia aplikacji. | [kompilacja RP](../../rp_native_lib/), [kompilacja STM32](../../stm32_lib/) |
...
| Kalendarz, NTP i czas rzeczywisty | Zawsze dostępne obliczenia kalendarza gregoriańskiego oraz wspólny zegar czasu rzeczywistego z synchronizacją dostępu między wątkami. Zegar udostępnia stan i źródło czasu, odtwarza czas z RTC, zachowuje dane NTP i integruje się z libc. W razie potrzeby przełącza się z głównego serwera NTP na jeden zapasowy, z określonymi limitami prób. | [hal_time.h](../../src/hal/time/hal_time.h) |
