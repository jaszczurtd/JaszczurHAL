...
| Manager Bluetooth Classic | Publiczne inquiry, kopiowane wyniki, pairing, SDP i indeksowane zarządzanie zapisanymi peerami współdzielone przez opcjonalne profile Classic. HID Host dodaje surowe deskryptory/raporty, a gamepad jest osobnym adapterem. Implementacje korzystają z CYW43/BTstack albo Bluedroid na oryginalnym ESP32. | [flagi modułów](../api/pl/02_module_flags.md), [API Bluetooth](../api/pl/20_bluetooth.md) |
| Bluetooth Classic HID i gamepad | Ogólny HID Host udostępnia jeden skopiowany deskryptor i ograniczone surowe raporty Input/Output/Feature bez założeń o urządzeniu. Opcjonalny adapter gamepada zwraca znormalizowane przyciski/osie/D-pad i zeruje wejścia po rozłączeniu. Deterministyczne mocki obejmują obie warstwy. | [hal_bluetooth_hid_host.h](../../src/hal/bluetooth/hal_bluetooth_hid_host.h), [hal_gamepad.h](../../src/hal/bluetooth/hal_gamepad.h) |
