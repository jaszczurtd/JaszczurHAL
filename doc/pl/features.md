...
| Bramka walidacji | Pełna lokalna bramka dla testów jednostkowych, kontroli Clang ASan/UBSan/libFuzzer, Valgrind, analizy statycznej, buildów targetów RP/STM, stanowisk ESP-IDF ESP32-S3 i gamepada Classic na oryginalnym ESP32 ograniczonych do buildu oraz przykładów. | [runalltests.sh](../../runalltests.sh) |
