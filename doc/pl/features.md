...
| Manager Bluetooth Classic | Publiczne inquiry, kopiowane wyniki, pairing, SDP i indeksowane zarządzanie zapisanymi peerami współdzielone przez opcjonalne profile Classic. HID Host dodaje surowe deskryptory/raporty, które można odpowiednio obsługiwać zdefiniowanym adapterem. Implementacje korzystają z CYW43/BTstack albo Bluedroid na oryginalnym ESP32. | [flagi modułów](../api/pl/02_module_flags.md), [API Bluetooth](../api/pl/20_bluetooth.md) |
...
| Bluetooth gamepad | Opcjonalny adapter gamepada, zbudowany jako klient Bluetooth Classic, zwracający znormalizowane przyciski/osie/D-pad i zeruje wejścia po rozłączeniu. | [hal_gamepad.h](../../src/hal/bluetooth/hal_gamepad.h) |
