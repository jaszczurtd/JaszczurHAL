...
| Pamięć klucz-wartość (K/V) | Lekka warstwa klucz-wartość oparta na pamięci flash (również wewnętrznej MCU), wraz z API get/set/commit zwracającym status (`hal_status_t`). | [hal_kv.h](../../src/hal/storage/hal_kv.h) |
