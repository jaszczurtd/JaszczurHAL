...
| 20 | [Bluetooth Low Energy](../api/en/20_bluetooth.md) | Peripheral and Observer lifecycle, advertising and scanning, connection events, ATT MTU, authenticated Stream, bounded queues, board support, coexistence, and BTstack distribution boundary |
