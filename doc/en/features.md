...
| ESP32 family backend | Implements the shared JaszczurHAL API on top of ESP-IDF. ESP32-S3 provides the delivered core, peripheral, network, NimBLE base-BLE and OTA set. Project tooling supplies generated board/memory configuration and build/upload/monitor/IntelliSense integration for both exact targets. | [ESP32 implementation](../../src/hal/impl/esp32/), [ESP32-S3 compile fixture](../../tests/fixtures/esp32s3_phase3/), [ESP32 gamepad compile fixture](../../tests/fixtures/esp32_gamepad/) |
