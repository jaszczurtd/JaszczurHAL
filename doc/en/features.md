...
| Manager Bluetooth Classic | Public inquiry, copied inquiry results, pairing, SDP, and indexed management of stored peers shared by optional Classic profiles. HID Host adds raw descriptors and reports that can be handled by a dedicated adapter. Implementations use either CYW43/BTstack or Bluedroid on the original ESP32. | [module flags](../api/en/02_module_flags.md), [Bluetooth API](../api/en/20_bluetooth.md) |
