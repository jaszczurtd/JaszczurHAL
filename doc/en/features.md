...
| Compiler portability | A common header provides consistent access to GNU, Clang, and MSVC extensions: noreturn, forced inline, trap/unreachable, structure packing, and leading-zero count. | [hal_compiler.h](../../src/hal/core/hal_compiler.h) |
