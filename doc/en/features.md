...
| Bluetooth Classic HID and gamepad | Generic HID Host exposes one copied descriptor and bounded raw Input/Output/Feature reports without device assumptions. The optional gamepad adapter returns normalized buttons/axes/D-pad snapshots and releases inputs on disconnect. Deterministic mocks cover both layers. | [hal_bluetooth_hid_host.h](../../src/hal/bluetooth/hal_bluetooth_hid_host.h), [hal_gamepad.h](../../src/hal/bluetooth/hal_gamepad.h) |
