...
| Validation gate | Full local gate for unit tests, Clang ASan/UBSan/libFuzzer checks, Valgrind, static analysis, RP/STM target builds, the compile-only ESP32-S3 multi-feature and original-ESP32 Classic-gamepad fixtures, and examples. | [runalltests.sh](../../runalltests.sh) |
