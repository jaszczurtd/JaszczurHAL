...
| ESP32 family backend | Implements the shared JaszczurHAL API on top of ESP-IDF. ESP32-S3 provides the delivered core, peripheral, network, NimBLE base-BLE and OTA set. Project tooling supplies generated board/memory configuration and build/upload/monitor/IntelliSense integration for both targets. | [ESP32 implementation](../../src/hal/impl/esp32/), [ESP32-S3 compile fixture](../../tests/fixtures/esp32s3_phase3/), [ESP32 gamepad compile fixture](../../tests/fixtures/esp32_gamepad/) |
...
| Bluetooth Classic HID gamepad | One nonblocking host profile with bounded pairing, current-runtime known-device reconnect, normalized buttons/axes/D-pad snapshots, explicit overflow reporting, disconnect input release, CYW43/BTstack and original-ESP32 Bluedroid backends, and a deterministic host mock. | [hal_gamepad.h](../../src/hal/bluetooth/hal_gamepad.h), [Bluetooth API](../api/en/20_bluetooth.md#bluetooth-classic-hid-gamepad) |
