...
#include "hal/core/hal_compiler.h" /* compiler attributes and builtins */
#include "hal/core/hal_target.h"   /* exact backend/target selection */
...
#ifndef HAL_KV_MAX_BANK_SIZE
#if HAL_TARGET_IS_RP
#define HAL_KV_MAX_BANK_SIZE (HAL_RP_FLASH_EEPROM_SIZE / 2u)
#elif HAL_TARGET_IS_STM32G474
#define HAL_KV_MAX_BANK_SIZE (HAL_STM32_FLASH_EEPROM_SIZE / 2u)
#else
#define HAL_KV_MAX_BANK_SIZE 4096u
#endif
#endif

#ifndef HAL_KV_PUBLISH_SIZE
...
#include "hal/system/hal_board.h" /* physical board profile and runtime capabilities */
#define JH_HAL_FEATURE_VERBOSE_REPORT_DEFERRED 1
#include "hal/generated/jh_hal_features.h" /* generated feature closure */
...
#include "hal/generated/jh_hal_features.h" /* final feature report */
