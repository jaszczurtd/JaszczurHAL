...
hal_status_t jh_cyw43_provider_init(void);
hal_status_t jh_cyw43_provider_deinit(void);
hal_status_t jh_cyw43_provider_join(const char *ssid, const char *password,
                                    bool non_blocking, uint32_t timeout_ms);
hal_status_t jh_cyw43_provider_leave(void);
hal_status_t
...
void jh_cyw43_provider_set_timeout_ms(uint32_t timeout_ms);
hal_status_t
...
hal_status_t jh_cyw43_provider_get_scan_result(size_t index,
