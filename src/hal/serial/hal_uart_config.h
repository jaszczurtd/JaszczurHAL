 ...
 * Existing SERIAL_* definitions take precedence; otherwise HAL fallback
 * values are used.
 */
 ...
 *
 * Values retain the established SERIAL_* bit layout used by existing callers.
 *
 * If the toolchain already provides SERIAL_* macros, HAL constants map
 * directly to those values. Other builds use the fallback values below.
 */

/* Established fallback bit layout. */
...
#else
#define HAL_UART_CFG_5N1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_NONE | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6N1
#define HAL_UART_CFG_6N1 ((uint16_t)(SERIAL_6N1))
#else
#define HAL_UART_CFG_6N1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_NONE | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7N1
#define HAL_UART_CFG_7N1 ((uint16_t)(SERIAL_7N1))
#else
#define HAL_UART_CFG_7N1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_NONE | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8N1
#define HAL_UART_CFG_8N1 ((uint16_t)(SERIAL_8N1))
#else
#define HAL_UART_CFG_8N1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_NONE | HAL_UART_DATA_8))
#endif
...
#else
#define HAL_UART_CFG_5N2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_NONE | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6N2
#define HAL_UART_CFG_6N2 ((uint16_t)(SERIAL_6N2))
#else
#define HAL_UART_CFG_6N2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_NONE | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7N2
#define HAL_UART_CFG_7N2 ((uint16_t)(SERIAL_7N2))
#else
#define HAL_UART_CFG_7N2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_NONE | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8N2
#define HAL_UART_CFG_8N2 ((uint16_t)(SERIAL_8N2))
#else
#define HAL_UART_CFG_8N2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_NONE | HAL_UART_DATA_8))
#endif
...
#else
#define HAL_UART_CFG_5E1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6E1
#define HAL_UART_CFG_6E1 ((uint16_t)(SERIAL_6E1))
#else
#define HAL_UART_CFG_6E1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7E1
#define HAL_UART_CFG_7E1 ((uint16_t)(SERIAL_7E1))
#else
#define HAL_UART_CFG_7E1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8E1
#define HAL_UART_CFG_8E1 ((uint16_t)(SERIAL_8E1))
#else
#define HAL_UART_CFG_8E1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_8))
#endif
...
#else
#define HAL_UART_CFG_5E2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6E2
#define HAL_UART_CFG_6E2 ((uint16_t)(SERIAL_6E2))
#else
#define HAL_UART_CFG_6E2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7E2
#define HAL_UART_CFG_7E2 ((uint16_t)(SERIAL_7E2))
#else
#define HAL_UART_CFG_7E2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8E2
#define HAL_UART_CFG_8E2 ((uint16_t)(SERIAL_8E2))
#else
#define HAL_UART_CFG_8E2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_EVEN | HAL_UART_DATA_8))
#endif
...
#else
#define HAL_UART_CFG_5O1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_ODD | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6O1
#define HAL_UART_CFG_6O1 ((uint16_t)(SERIAL_6O1))
#else
#define HAL_UART_CFG_6O1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_ODD | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7O1
#define HAL_UART_CFG_7O1 ((uint16_t)(SERIAL_7O1))
#else
#define HAL_UART_CFG_7O1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_ODD | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8O1
#define HAL_UART_CFG_8O1 ((uint16_t)(SERIAL_8O1))
#else
#define HAL_UART_CFG_8O1                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_1 | HAL_UART_PARITY_ODD | HAL_UART_DATA_8))
#endif
...
#else
#define HAL_UART_CFG_5O2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_ODD | HAL_UART_DATA_5))
#endif
#ifdef SERIAL_6O2
#define HAL_UART_CFG_6O2 ((uint16_t)(SERIAL_6O2))
#else
#define HAL_UART_CFG_6O2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_ODD | HAL_UART_DATA_6))
#endif
#ifdef SERIAL_7O2
#define HAL_UART_CFG_7O2 ((uint16_t)(SERIAL_7O2))
#else
#define HAL_UART_CFG_7O2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_ODD | HAL_UART_DATA_7))
#endif
#ifdef SERIAL_8O2
#define HAL_UART_CFG_8O2 ((uint16_t)(SERIAL_8O2))
#else
#define HAL_UART_CFG_8O2                                                       \
  ((uint16_t)(HAL_UART_STOP_BIT_2 | HAL_UART_PARITY_ODD | HAL_UART_DATA_8))
#endif

/* Backward-compatible aliases for existing code that passes SERIAL_*. */
#ifndef SERIAL_7N1
