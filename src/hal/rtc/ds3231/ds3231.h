...
public:
  ...
  DateTime(uint16_t year, uint8_t month, uint8_t day, uint8_t hour = 0u,
           uint8_t min = 0u, uint8_t sec = 0u);
...
public:
  ...
  void getA2Time(byte &A2Day, byte &A2Hour, byte &A2Minute, byte &AlarmBits,
                 bool &A2Dy, bool &A2h12, bool &A2PM);
  void getA1Time(byte &A1Day, byte &A1Hour, byte &A1Minute, byte &A1Second,
                 byte &AlarmBits, bool &A1Dy, bool &A1h12, bool &A1PM,
                 bool clearAlarmBits);
  void getA2Time(byte &A1Day, byte &A1Hour, byte &A1Minute, byte &AlarmBits,
                 bool &A1Dy, bool &A1h12, bool &A1PM, bool clearAlarmBits);
