...
enum {
  JH_CLASSIC_HID_EXPECTED_VENDOR_ID = 0x2dc8u,
  JH_CLASSIC_HID_EXPECTED_PRODUCT_ID = 0x3230u,
  JH_CLASSIC_HID_EXPECTED_VERSION = 0x0100u,
  JH_CLASSIC_HID_DISCOVERY_WINDOW_MS = 120000u,
  JH_CLASSIC_HID_CONTROL_COUNT = 12u,
  JH_CLASSIC_HID_ALL_CONTROLS_MASK = 0x0fffu,
};

#define JH_CLASSIC_HID_EXPECTED_NAME "8BitDo Zero 2 gamepad"
