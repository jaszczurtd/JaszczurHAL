...
typedef hal_status_t (*jh_bluetooth_controller_service_fn)(void *context);
typedef void (*jh_bluetooth_controller_invalidation_fn)(void *context,
                                                        uint32_t generation);

typedef struct {
  void *context;
  hal_status_t (*start)(void *context,
                        jh_bluetooth_controller_service_fn service,
...
} jh_bluetooth_controller_t;

/** Return the Bluetooth controller selected by the active target backend. */
const jh_bluetooth_controller_t *jh_bluetooth_controller_backend(void);
