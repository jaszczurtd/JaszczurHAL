...
#define HAL_BOARD_CAP_ALL (HAL_BOARD_CAP_USB_DEVICE | HAL_BOARD_CAP_CYW43 | HAL_BOARD_CAP_EXTERNAL_RADIO_FRONTEND | HAL_BOARD_CAP_SX1262_RADIO | HAL_BOARD_CAP_BLUETOOTH_CONTROLLER)
