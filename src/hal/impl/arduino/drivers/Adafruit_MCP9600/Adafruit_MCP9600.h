...
private:
  void lock_bus_(void);
  void unlock_bus_(void);
  bool read_register_(uint8_t reg, uint8_t *data, uint8_t len);
  bool write_register_(uint8_t reg, const uint8_t *data, uint8_t len);
  bool read_register_u8_(uint8_t reg, uint8_t &value);
  bool write_register_u8_(uint8_t reg, uint8_t value);
