...
// If DMA is enabled, Arduino sketch MUST #include "../Adafruit_Zero_DMA_Library/Adafruit_ZeroDMA.h"
// Estimated RAM usage:
// 4 bytes/pixel on display major axis + 8 bytes/pixel on minor axis,
// e.g. 320x240 pixels = 320 * 4 + 240 * 8 = 3,200 bytes.

#if defined(USE_SPI_DMA) && (defined(__SAMD51__) || defined(ARDUINO_SAMD_ZERO))
#include "../Adafruit_Zero_DMA_Library/Adafruit_ZeroDMA.h"
#endif
...
protected:
  ...
  uint8_t _halSpiBus = 0;  ///< JaszczurHAL SPI bus index for lock/unlock
  bool _halSpiLocked = false; ///< True while hal_spi_lock is held
