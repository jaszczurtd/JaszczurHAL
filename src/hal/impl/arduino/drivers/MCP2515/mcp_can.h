...
class MCP_CAN
{
    ...
    INT8U   m_spiBus;                                                   // SPI bus index for hal_spi lock
    hal_mutex_t m_driver_mutex;                                         // Guard whole MCP2515 transactions
 ...
 *********************************************************************************************************/
   ...
   private:
    ...
    void spi_begin_(void);                                              // Begin SPI transaction + lock bus
    void spi_end_(void);                                                // End SPI transaction + unlock bus
    void lock_driver_(void);                                            // Lock full driver operation
    void unlock_driver_(void);                                          // Unlock full driver operation
