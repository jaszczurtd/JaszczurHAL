 ...
 * (impl/shared/frameworks/gps/hal_gps_core.cpp). The GPS receiver is wired to
 * USART1 (HAL_UART_PORT_1); the rx/tx pins passed to hal_gps_init() are
 * forwarded to hal_uart_create(). */
