...
/* STM32G474 GPS backend: serial transport only. NMEA parsing and the hal_gps_*
 * getters live in the shared engine
 * (impl/shared/frameworks/gps/hal_gps_core.cpp).
 *
 * The transport can be hardware UART or SoftwareSerial. Selection is
 * compile-time:
...
#define GPS_STM32G474_UART 1
#elif defined(HAL_GPS_TRANSPORT_SWSERIAL)
#define GPS_STM32G474_SWSERIAL 1
...
#endif /* GPS_STM32G474_SWSERIAL */

/* ──────────────────────────────── UART ──────────────────────────────────── */
#ifdef GPS_STM32G474_UART
#include "../../hal_uart.h"
