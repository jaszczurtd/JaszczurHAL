/*
 * Classic 5x7 fixed-space bitmap font.
 *
 * Standard ASCII character set (256 glyphs, 5 bytes per glyph).
 * Originally part of the Adafruit GFX Library (BSD-2-Clause).
 * Included here as a standalone data table without platform dependencies.
 */

#ifndef JH_GFX_GLCDFONT_H
#define JH_GFX_GLCDFONT_H

#include <stdint.h>

static const unsigned char jh_gfx_builtin_font[] = {
