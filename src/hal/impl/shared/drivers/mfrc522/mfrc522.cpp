...
MFRC522::StatusCode MFRC522::PICC_Select(
  ...
  //Level: PICC_CMD_SEL_CL1, PICC_CMD_SEL_CL2 or PICC_CMD_SEL_CL3 		Byte 1: NVB
  ...
  //See explanation below. CT means Cascade Tag. 		Byte 3: UID-data 		Byte 4:
  //UID-data 		Byte 5: UID-data 		Byte 6: BCC
