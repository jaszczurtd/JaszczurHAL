...
#define HTTP_HDR_KEEPALIVE_LEN                                                 \
  11 /* Connection: keep-alive + Content-Length: (HTTP 1.1)*/
...
/** A list of extension-to-HTTP header strings (see outdated RFC 1700 MEDIA
 * TYPES and http://www.iana.org/assignments/media-types for registered content
 * types and subtypes) */
