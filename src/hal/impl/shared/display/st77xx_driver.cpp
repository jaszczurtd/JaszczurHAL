...
#include "../../../hal_config.h"
    ...
    (defined(HAL_ENABLE_ST7735) || defined(HAL_ENABLE_ST7789) || defined(HAL_ENABLE_ST7796S))
...
static const uint8_t s_st7735_bcmd[] = {
    18u,
    ST77XX_SWRESET, ST_CMD_DELAY, 50u,
    ST77XX_SLPOUT, ST_CMD_DELAY, 255u,
    ST77XX_COLMOD, 1u + ST_CMD_DELAY, 0x05u, 10u,
    ST7735_FRMCTR1, 3u + ST_CMD_DELAY, 0x00u, 0x06u, 0x03u, 10u,
    ST77XX_MADCTL, 1u, 0x08u,
    ST7735_DISSET5, 2u, 0x15u, 0x02u,
    ST7735_INVCTR, 1u, 0x00u,
    ST7735_PWCTR1, 2u + ST_CMD_DELAY, 0x02u, 0x70u, 10u,
    ST7735_PWCTR2, 1u, 0x05u,
    ST7735_PWCTR3, 2u, 0x01u, 0x02u,
    ST7735_VMCTR1, 2u + ST_CMD_DELAY, 0x3Cu, 0x38u, 10u,
    ST7735_PWCTR6, 2u, 0x11u, 0x15u,
    ST7735_GMCTRP1, 16u,
        0x09u, 0x16u, 0x09u, 0x20u, 0x21u, 0x1Bu, 0x13u, 0x19u,
        0x17u, 0x15u, 0x1Eu, 0x2Bu, 0x04u, 0x05u, 0x02u, 0x0Eu,
    ST7735_GMCTRN1, 16u + ST_CMD_DELAY,
        0x0Bu, 0x14u, 0x08u, 0x1Eu, 0x22u, 0x1Du, 0x18u, 0x1Eu,
        0x1Bu, 0x1Au, 0x24u, 0x2Bu, 0x06u, 0x06u, 0x02u, 0x0Fu,
        10u,
    ST77XX_CASET, 4u, 0x00u, 0x02u, 0x00u, 0x81u,
    ST77XX_RASET, 4u, 0x00u, 0x02u, 0x00u, 0x81u,
    ST77XX_NORON, ST_CMD_DELAY, 10u,
    ST77XX_DISPON, ST_CMD_DELAY, 255u
};

static const uint8_t s_st7735_rcmd1[] = {
    15u,
    ST77XX_SWRESET, ST_CMD_DELAY, 150u,
    ST77XX_SLPOUT, ST_CMD_DELAY, 255u,
    ST7735_FRMCTR1, 3u, 0x01u, 0x2Cu, 0x2Du,
    ST7735_FRMCTR2, 3u, 0x01u, 0x2Cu, 0x2Du,
    ST7735_FRMCTR3, 6u, 0x01u, 0x2Cu, 0x2Du, 0x01u, 0x2Cu, 0x2Du,
    ST7735_INVCTR, 1u, 0x07u,
    ST7735_PWCTR1, 3u, 0xA2u, 0x02u, 0x84u,
    ST7735_PWCTR2, 1u, 0xC5u,
    ST7735_PWCTR3, 2u, 0x0Au, 0x00u,
    ST7735_PWCTR4, 2u, 0x8Au, 0x2Au,
    ST7735_PWCTR5, 2u, 0x8Au, 0xEEu,
    ST7735_VMCTR1, 1u, 0x0Eu,
    ST77XX_INVOFF, 0u,
    ST77XX_MADCTL, 1u, 0xC8u,
    ST77XX_COLMOD, 1u, 0x05u
};
...
static const uint8_t s_st7735_rcmd2_red[] = {
    2u,
    ST77XX_CASET, 4u, 0x00u, 0x00u, 0x00u, 0x7Fu,
...
static const uint8_t s_st7735_rcmd2_green160x80[] = {
    2u,
    ST77XX_CASET, 4u, 0x00u, 0x00u, 0x00u, 0x4Fu,
    ST77XX_RASET, 4u, 0x00u, 0x00u, 0x00u, 0x9Fu
};
...
static const uint8_t s_st7735_rcmd3[] = {
    ...
    ST77XX_NORON, ST_CMD_DELAY, 10u,
    ST77XX_DISPON, ST_CMD_DELAY, 100u
};

static const uint8_t s_st7789_init[] = {
    9u,
    ST77XX_SWRESET, ST_CMD_DELAY, 150u,
    ST77XX_SLPOUT, ST_CMD_DELAY, 10u,
    ST77XX_COLMOD, 1u + ST_CMD_DELAY, 0x55u, 10u,
    ST77XX_MADCTL, 1u, 0x08u,
    ST77XX_CASET, 4u, 0x00u, 0x00u, 0x00u, 0xF0u,
    ST77XX_RASET, 4u, 0x00u, 0x00u, 0x01u, 0x40u,
    ST77XX_INVON, ST_CMD_DELAY, 10u,
    ST77XX_NORON, ST_CMD_DELAY, 10u,
    ST77XX_DISPON, ST_CMD_DELAY, 10u
};

static const uint8_t s_st7796s_init[] = {
    14u,
    ST77XX_SWRESET, ST_CMD_DELAY, 150u,
    0xF0u, 1u, 0xC3u,
    0xF0u, 1u, 0x96u,
    0xC5u, 1u, 0x1Cu,
    ST77XX_MADCTL, 1u, 0x48u,
    ST77XX_COLMOD, 1u, 0x55u,
    0xB0u, 1u, 0x80u,
    0xB4u, 1u, 0x00u,
    0xB6u, 3u, 0x80u, 0x02u, 0x3Bu,
    0xB7u, 1u, 0xC6u,
    0xF0u, 1u, 0x69u,
    0xF0u, 1u, 0x3Cu,
    ST77XX_SLPOUT, ST_CMD_DELAY, 150u,
    ST77XX_DISPON, ST_CMD_DELAY, 150u
};
...
static bool write_command(jh_st77xx_t *dev,
                          uint8_t command,
                          const uint8_t *data,
                          uint8_t data_len) {
...
static void set_default_geometry(jh_st77xx_t *dev) {
    ...
    switch (dev->config.chip) {
        case JH_ST77XX_CHIP_ST7735:
            dev->window_width = dev->config.width ? dev->config.width : JH_ST7735_TFTWIDTH_128;
            dev->window_height = dev->config.height ? dev->config.height : JH_ST7735_TFTHEIGHT_160;
        ...
        case JH_ST77XX_CHIP_ST7789:
            ...
            break;
        case JH_ST77XX_CHIP_ST7796S:
            dev->window_width = dev->config.width ? dev->config.width : JH_ST7796S_TFTWIDTH;
            dev->window_height = dev->config.height ? dev->config.height : JH_ST7796S_TFTHEIGHT;
            dev->width = dev->window_width;
            dev->height = dev->window_height;
...
static void configure_st7735_after_sequence(jh_st77xx_t *dev) {
    ...
    if (tab == JH_ST7735_TAB_GREENTAB) {
        dev->col_start = 2u;
        dev->row_start = 1u;
    } else if (tab == JH_ST7735_TAB_144GREENTAB || tab == JH_ST7735_TAB_HALLOWING) {
        dev->window_width = dev->config.width ? dev->config.width : JH_ST7735_TFTWIDTH_128;
        dev->window_height = dev->config.height ? dev->config.height : JH_ST7735_TFTHEIGHT_128;
        dev->col_start = 2u;
        dev->row_start = 3u;
    } else if (tab == JH_ST7735_TAB_MINI160X80) {
        dev->window_width = dev->config.width ? dev->config.width : JH_ST7735_TFTWIDTH_80;
        dev->window_height = dev->config.height ? dev->config.height : JH_ST7735_TFTHEIGHT_160;
        dev->col_start = 24u;
        dev->row_start = 0u;
...
bool jh_st77xx_set_rotation(jh_st77xx_t *dev, uint8_t rotation) {
    ...
    if (dev->config.chip == JH_ST77XX_CHIP_ST7735) {
        const uint8_t tab = dev->config.st7735_tab;
        const bool rgb_tab = tab == JH_ST7735_TAB_BLACKTAB ||
                             tab == JH_ST7735_TAB_MINI160X80;
        ...
        switch (dev->rotation) {
            ...
            case 2:
                ...
                break;
            default:
                madctl = ST77XX_MADCTL_MY | ST77XX_MADCTL_MX |
...
bool jh_st77xx_invert(jh_st77xx_t *dev, bool invert) {
    ...
    dev->inverted = invert;
    return write_command(dev,
                         invert ? dev->invert_on_command : dev->invert_off_command,
                         NULL,
                         0u);
}
...
bool jh_st77xx_set_addr_window(jh_st77xx_t *dev,
                               uint16_t x,
                               uint16_t y,
                               uint16_t w,
                               uint16_t h) {
...
bool jh_st77xx_write_pixels(jh_st77xx_t *dev,
...
bool jh_st77xx_fill_rect(jh_st77xx_t *dev,
                         uint16_t x,
                         uint16_t y,
                         uint16_t w,
                         uint16_t h,
...
bool jh_st77xx_draw_rgb_bitmap(jh_st77xx_t *dev,
                               uint16_t x,
                               uint16_t y,
                               const uint16_t *pixels,
                               uint16_t w,
