...
void test_destroy_null_is_safe(void) { hal_soft_timer_destroy(NULL); }
...
void test_tick_null_is_safe(void) { hal_soft_timer_tick(NULL); }
...
void test_setup_table_creates_timers(void) {
  ...
  hal_soft_timer_table_entry_t table[] = {{&ta, cb_a, 100}, {&tb, cb_b, 200}};
...
void test_setup_table_calls_idle_callback(void) {
  ...
  hal_soft_timer_table_entry_t table[] = {
      {&ta, cb_a, 100}, {&tb, cb_b, 200}, {&tc, cb_c, 300}};
...
void test_setup_table_no_delay_for_single_entry(void) {
  hal_soft_timer_t ta = NULL;
  hal_soft_timer_table_entry_t table[] = {{&ta, cb_a, 100}};
...
void test_tick_table_fires_all_elapsed(void) {
  ...
  hal_soft_timer_t tc = NULL;
  hal_soft_timer_table_entry_t table[] = {
      {&ta, cb_a, 100}, {&tb, cb_b, 100}, {&tc, cb_c, 200}};
...
void test_tick_table_repeated_ticks(void) {
  hal_soft_timer_t ta = NULL;
  hal_soft_timer_table_entry_t table[] = {{&ta, cb_a, 50}};
