...
set(_pico_core1262
    -DJH_EXPECT_PROFILE=HAL_BOARD_RP_PICO_CORE1262_HF -DJH_EXPECT_USB=1
    -DJH_EXPECT_EXTERNAL_RADIO=1 -DJH_EXPECT_SX1262=1 -DJH_EXPECT_LED=25
    -DJH_EXPECT_NAME="pico-core1262-hf")
set(_nucleo
...
check_board(explicit_rp2040_lora TRUE ""
    ...
    ${_rp2040_lora})
check_board(explicit_pico_core1262 TRUE ""
    -DHAL_TARGET_RP2040=1 -DHAL_BOARD_PROFILE_RP_PICO_CORE1262_HF=1
    ${_pico_core1262})
...
check_board(explicit_nucleo_core1262 TRUE ""
    -DHAL_TARGET_STM32G474=1
