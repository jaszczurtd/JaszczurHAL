...
void test_write16_out_of_range_ignored(void) {
  ...
  TEST_ASSERT_EQUAL_UINT8(
      0, hal_i2c_slave_reg_read8(HAL_I2C_SLAVE_REG_MAP_SIZE - 1));
}

void test_read16_out_of_range_returns_zero(void) {
  TEST_ASSERT_EQUAL_HEX16(
      0, hal_i2c_slave_reg_read16(HAL_I2C_SLAVE_REG_MAP_SIZE - 1));
}
...
void test_mock_get_reg_out_of_range(void) {
  TEST_ASSERT_EQUAL_UINT8(
      0, hal_mock_i2c_slave_get_reg(HAL_I2C_SLAVE_REG_MAP_SIZE));
}
