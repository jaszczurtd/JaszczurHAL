...
function(jh_target_enable_cyw43_feature_stack TARGET_NAME)
    ...
    if(JH_CYW43_FEATURE_UNPARSED_ARGUMENTS)
        message(FATAL_ERROR
            ...
            "${JH_CYW43_FEATURE_UNPARSED_ARGUMENTS}")
    endif()
    if(JH_CYW43_FEATURE_KEYWORDS_MISSING_VALUES)
        message(FATAL_ERROR
            "CYW43 feature-stack arguments require values: "
            "${JH_CYW43_FEATURE_KEYWORDS_MISSING_VALUES}")
    endif()
    ...
    elseif(JH_CYW43_FEATURE_BLUETOOTH_CLASSIC_HID_DEVICE_FIXTURE)
        ...
        endforeach()
        if(_jh_btstack_profiles)
            jh_target_enable_btstack_profiles(
                ${TARGET_NAME} ${_jh_btstack_profiles})
        endif()
    endif()
endfunction()
