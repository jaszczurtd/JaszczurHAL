...
read-only media, drive removal, and write errors remain upload failures.

Native Windows tests exercise real volume enumeration and durable file-handle flush
...
has passed on RP2040 and RP2350.

The shared runtime also resolves managed GNU
