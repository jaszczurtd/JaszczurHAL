...
`tools/create-vscode-example.py` also mirror the initial dispatcher cache into
`.vscode/settings.json` as `cmake.configureSettings`, so VS Code CMake Tools can
configure the shared dispatcher directly.
